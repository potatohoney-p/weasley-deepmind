...
| `onboarding` | System usage guide | Helps AI self-learn when and how to use weasley-deepmind tools |
...
Returns the weasley-deepmind best practices guide. Comprehensive skill reference covering memory tool usage, session lifecycle, keyword rules, search strategies, experiential memory usage, and more.
