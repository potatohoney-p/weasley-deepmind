...
export const usage = [
  "Usage: weasley-deepmind import [options]",
  "       weasley-deepmind import < backup.jsonl",
  "",
  ...
  "",
  "Examples:",
  "  weasley-deepmind import --input backup.jsonl",
  "  weasley-deepmind import --input backup.jsonl --idempotent",
  "  cat backup.jsonl | weasley-deepmind import --dry-run",
  "  weasley-deepmind import < backup.jsonl --idempotent --json",
].join("\n");
