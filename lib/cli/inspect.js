...
export const usage = [
  "Usage: weasley-deepmind inspect <fragment-id> [options]",
  "",
  ...
  "",
  "Examples:",
  "  weasley-deepmind inspect abc123",
  "  weasley-deepmind inspect abc123 --json",
  "  weasley-deepmind inspect abc123 --remote https://deepmind.example.com/mcp --key wdm_xxx",
].join("\n");

export default async function inspect(args) {
  const id = args._[0];
  if (!id) {
    console.error("Usage: weasley_deepmind inspect <fragment-id> [--json]");
    process.exit(1);
  }
