 ...
 *
 * Usage:
 *   weasley-deepmind completion bash   # bash 자동완성 스크립트를 stdout에 출력
 *   weasley-deepmind completion zsh    # zsh 자동완성 스크립트를 stdout에 출력
 *
 * 사용자는 아래처럼 로드한다:
 *   source <(weasley-deepmind completion bash)
 *   source <(weasley-deepmind completion zsh)
 */

export const usage = [
  "Usage: weasley-deepmind completion <shell>",
  "",
  ...
  "  source <(weasley-deepmind completion bash)",
  "  source <(weasley-deepmind completion zsh)",
  "  weasley-deepmind completion bash >> ~/.bash_completion",
].join("\n");
...
function buildBashScript() {
  ...
  return [
    "# bash completion for weasley-deepmind",
    "# source this file or add to ~/.bash_completion",
    "# Usage: source <(weasley-deepmind completion bash)",
    "",
    "_weasley_deepmind_complete() {",
    ...
    "}",
    "",
    "complete -F _weasley_deepmind_complete weasley-deepmind",
    "",
  ].join("\n");
}
...
function buildZshScript() {
  ...
  return [
    "# zsh completion for weasley-deepmind (bash-compat mode)",
    "# source this file or add to ~/.zshrc",
    "# Usage: source <(weasley-deepmind completion zsh)",
    "",
