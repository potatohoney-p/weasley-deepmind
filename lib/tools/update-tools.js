...
function _getManualCommand(type) {
  return ({
    ...
    "npm-local":  "npm update weasley-deepmind",
    "npm-global": "npm install -g weasley-deepmind@latest",
    docker:       "docker pull ghcr.io/potatohoney-p/weasley-deepmind:latest",
    unknown:      "https://github.com/potatohoney-p/weasley-deepmind/releases"
  })[type] || "https://github.com/potatohoney-p/weasley-deepmind/releases";
}
