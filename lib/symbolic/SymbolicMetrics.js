 ...
 *
 * 4종 지표:
 * - weasley_deepmind_symbolic_warning_total        : 검증 단계에서 발생한 warning 수
 * - weasley_deepmind_symbolic_gate_blocked_total   : symbolic 게이트에서 차단된 작업 수
 * - weasley_deepmind_symbolic_claim_extracted_total: 추출된 claim 수
 * - weasley_deepmind_symbolic_op_latency_ms        : symbolic 연산 레이턴시 히스토그램 (ms)
 *
...
export const symbolicWarningTotal = new prometheus.Counter({
  name      : "weasley_deepmind_symbolic_warning_total",
...
export const symbolicGateBlockedTotal = new prometheus.Counter({
  name      : "weasley_deepmind_symbolic_gate_blocked_total",
...
export const symbolicClaimExtractedTotal = new prometheus.Counter({
  name      : "weasley_deepmind_symbolic_claim_extracted_total",
  help      : "추출된 claim 수",
...
export const symbolicOpLatencyMs = new prometheus.Histogram({
  name      : "weasley_deepmind_symbolic_op_latency_ms",
