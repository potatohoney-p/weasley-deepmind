 ...
 * 작성일: 2026-05-13
 *
 * WEASLEY_DEEPMIND_STORAGE 환경변수로 어댑터를 선택한다.
...
/**
 * 환경변수 WEASLEY_DEEPMIND_STORAGE에 따라 스토리지 어댑터 싱글톤을 반환한다.
 *
 * 지원 값:
...
export function getStorage() {
  ...
  const backend = (process.env.WEASLEY_DEEPMIND_STORAGE || "pgvector").toLowerCase().trim();
